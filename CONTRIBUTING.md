# Contributing to stapel-analytics
...
```bash
git clone https://github.com/usestapel/stapel-analytics.git && cd stapel-analytics
...
- **No new hardcoded behavior.** Anything a host project might want to
  ...
  (`STAPEL_ANALYTICS` dict; see `conf.py`) — with a dotted-path
